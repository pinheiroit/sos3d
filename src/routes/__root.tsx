  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          Algo deu errado por aqui. Tente novamente ou volte para a página inicial.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SOS.3D — Tecnologia em manufatura aditiva, laser e design" },
      {
        name: "description",
        content:
          "Impressoras 3D, filamentos, acessórios, impressão sob demanda e suporte técnico para empresas, escolas, profissionais e makers.",
      },
      { name: "author", content: "SOS.3D" },
